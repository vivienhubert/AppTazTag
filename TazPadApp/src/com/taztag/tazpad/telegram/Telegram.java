	...
	public Telegram(String trame){
		...
		public String getData(){
			...
			if(this.getTelegramType()=="RPS")
				...
				if(valByteCurrent.equals("50")){Data=" Bouton PressŽ Interrupteur Bas";}
				else if(valByteCurrent.equals("70")){Data=" Bouton PressŽ Interrupteur Haut";}
				else if(valByteCurrent.equals("00")){Data=" Bouton Released ";}
				else if(valByteCurrent.equals("10")){Data=" Bouton PressŽ";}
